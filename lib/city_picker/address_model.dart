class AddressProvince {
  ...
  final AddressCity _allCity =
      AddressCity(city: '全部', district: [AddressDistrict(area: '全部')]);
  ...
  AddressProvince.fromJson(Map<String, dynamic> json,
      {Map<String, AddressCity> cityMap,
      Map<String, AddressDistrict> districtMap}) {
    id = json['id'];
...
class AddressCity {
  ...
  final AddressDistrict _allDistrict = AddressDistrict(area: '全部');
  ...
  AddressCity.fromJson(Map<String, dynamic> json,
    ...
    if (json['district'] != null) {
      ...
      district.insert(0, _allDistrict);
    }
  }
...
class AddressDistrict {
  ...
  AddressDistrict(
      {this.id, this.area, this.areaid, this.cityid, this.lng, this.lat});
